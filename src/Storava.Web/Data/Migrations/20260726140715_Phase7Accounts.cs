...
{
    /// <inheritdoc />
    public partial class Phase7Accounts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientLabel = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    Meter = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    DisplayName = table.Column<string>(type: "character varying(120)", maxLength: 120, nullable: false),
                    DeviceType = table.Column<string>(type: "character varying(48)", maxLength: 48, nullable: false),
                    PublicKeyThumbprint = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    LastSeenAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    RevokedAtUtc = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountSessions_ExpiresAtUtc",
                table: "AccountSessions",
                column: "ExpiresAtUtc");

            migrationBuilder.CreateIndex(
                name: "IX_AccountSessions_UserId_RevokedAtUtc",
                table: "AccountSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageLedger_UserId_RecordedAtUtc",
                table: "UsageLedger",
                columns: new[] { "UserId", "RecordedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_UserDevices_PublicKeyThumbprint",
                table: "UserDevices",
                column: "PublicKeyThumbprint",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserDevices_UserId_RevokedAtUtc",
                table: "UserDevices",
                columns: new[] { "UserId", "RevokedAtUtc" });
        }
